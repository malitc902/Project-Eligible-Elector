...
if age >= 18: # Check if the user is 18 or older
    ...
    years_left = 18 - age  # Calculate the remaining years 18-age
    print("Oops! You're not eligible to vote yet. But hey, only " + str(years_left) + " more years to go!") 
    # Print a message indicating how many years are left until they can vote. We're using double-quote plus adding str years_left plus adding the last double-quote.
